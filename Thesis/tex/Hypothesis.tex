...
The seller $h_{i+1}$ is unable to sell to $h_i$ because of the lower optimism-factor and is unable to sell to $h_{i+2}$ obviously because of a non-existent connection. Depending on whether this violation happens in the pessimists, medianists or optimists different things happen.
...
The buyer $h_{i+2}$ is unable to buy from $h_{i+1}$ because of a non-existent connection. Depending on whether this violation happens in the pessimists, medianists or optimists different things happen.
...
\item Bond/Cash market - $h_{i+2}$ sells bonds up to $h_{i+3}$ transforming to cash but can't use the cash because of the missing link to seller $h_{i+1}$. Same as in Asset/Cash market.
\item Asset/Bond market - $h_{i+2}$ sells assets against bonds up to $h_{i+3}$ transforming assets to bonds but can't use the bonds to buy goods because of the missing link to seller $h_{i+1}$.  Same as in Asset/Cash market.
\end{itemize}
...
Obviously the buyer $h_{i+2}$ is unable to trade with the seller $h_{i+1}$ because of a non-existent connection thus it is trivial to see that theoretical equilibrium cannot be reached.
