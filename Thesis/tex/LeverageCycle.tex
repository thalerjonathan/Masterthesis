...
TODO: move to next section of utility
...
utility cash = (assets selling - assets buying) * asset-price + (bonds giving - bonds taking) * bond-price + cash endowment
...
$e_{cash} \dots \textit{endowment cash}$

\begin{equation}
u_{cash} = (s_{asset} - b_{asset} ) p_{asset} + (g_{bond} - t_{bond}) p_{bond} + e_{cash}
\end{equation}

\subsubsection{Asset utility}
utility asset = asset holdings * asset limit 

$h_{asset} \dots \textit{holdings asset}$ \\

\begin{equation}
u_{asset} = h_{asset} * \ell_{asset}
\end{equation}

\subsubsection{Bond utility}
utility bond = bond holdings * bond limit

$h_{bond} \dots \textit{holdings bond}$ 

\begin{equation}
u_{bond} = h_{bond} * \ell_{bond}
\end{equation}
