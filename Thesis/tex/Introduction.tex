...
\cite{Breuer2015} developed a simulation on top of the model of Geanakoplos in which zero-intelligence agents trade assets and loans in a continuous double auction. They wanted to better understand the dynamic of such a theoretical process and how prices develop instead of being predicted through an equilibrium theory. 
The paper \cite{Breuer2015} is unique in that it presents double auctions for leveraged assets and show how collateral is cleared and how leveraged purchases are coordinated across asset and debt markets. They could show that in their simulation trading prices and wealth-distribution approach the theoretical equilibrium of Geanakoplos.
