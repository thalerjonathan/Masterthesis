function [ output_args ] = expectedJ( N, j )
%EXPECTEDJ Summary of this function goes here
%   Detailed explanation goes here
    ...
    for i = 0 : N
        ...
        data( i + 1 ) = limitPriceBond;
    end
    
    plot( data, '-X' );
    title( sprintf( 'Limit Price for Bond with Facevalue %0.1f of %d Agents', j, ( N + 1 ) ) );
    legend( 'Price' );
    xlabel( 'Agent' );
    ylabel( 'Limit-Price' );
