...
The major conclusion on the findings of the thesis is that equilibrium seems only to be possible in a fully-connected trading-network. Thus as soon as a market-institution exhibits signs of restricting trades between agents to a reduced neighbourhood, it will lead to miss-allocation and fail reaching equilibrium and thus will be unfair. The introduction of a new market solves the miss-allocations in theory but to the best knowledge of the author of this thesis such a market does not exist yet and it is open to question whether such a market can be put into practice in the real world and whether agents accept its products and the impact it has on the real-world trading.
