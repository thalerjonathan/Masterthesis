...
\begin{table}[H]
	\caption{Difference of Ascending-Connected topology to equilibrium of Fully-Connected topology with Collateral/Cash as given in Table \ref{tab:ascendingconnected_equilibrium_100Agents_05Bond} TODO: correct table}
	\centering
	\begin{tabular} { l c c c r }
		& Result & Reference & difference to Reference \\
		\hline
...
The Bond/Cash market fluctuates around the same point as bonds are traded more or less equally the same.
