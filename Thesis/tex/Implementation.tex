...
As already defined in chapter \ref{ch:leverageCycle} "The Leverage Cycle" the BP-mechanism allows to free a collateralized asset by buying a bond. \cite{Breuer2015} define it technically: 
