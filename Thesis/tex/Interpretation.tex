...
\paragraph{Blocking-Situation prevents trading} As already outlined the artefacts arise due to a blocking situation where trading becomes and \textit{stays} impossible between two neighbours. The seller places ask-offerings on a given market but due to trading constraints the only potential buyer which is the neighbour with the next higher optimism-factor can't place any potential matching bid-offering on the given market. In figure \ref{fig:wealth_ASCENDINGCONNECTED_100_NOCOLLATERALMARKET_SINGLE} this blocking-situation can be seen between the agent-pairs 55 (0.545) \& 56 (0.554), 57 (0.564) \& 58 (0.574), 62 (0.614) \& 63 (0.624), 64 (0.634) \& 65 (0.644) and 68 (0.673) \& 69 (0.683). In all pairs the seller, which is the agent with the lower optimism-factor, holds only collateralized assets and thus places ask-offers only on the Asset/Bond market. The buyer, which is the agent with the higher optimism-factor, holds only cash and places bid-offers only on the Asset/Cash and Bond/Cash market but not on the Asset/Bond market - trading has become impossible between the two agents. It is interesting to see that the wealth-distribution in the range of 0.455 - 0.554 already shows basic similarities to the global distribution because all wealth is traded up towards the blocking-point creating the small sub-distribution of pessimists, medianists and optimists.

\paragraph{Situation can occur only on the Asset/Bond market.} It is of very importance to note that an agent can never have a total utility of 0 in this simulation as per definition in chapter \ref{ch:leverageCycle} each trade results in a utility-increase. Thus because the blocking buyer has no assets at all because it is a pessimist, it will hold only cash for the asset it has sold. A blocking situation can only occur if agents hold only extreme allocations of wealth which means only one kind of good and nothing else as in a mix of goods they can still trade TODO: formal beweisen. The following extreme allocations are possible: cash, free assets, positive bonds, collateralized assets only. When applying linear-combination to the extreme allocations the following situations could arise:

\begin{enumerate}
\item Seller has cash only, buyer any \\ Seller does not sell anything thus no blocking possible. 
\item Seller has positive bonds only, buyer has cash only \\ Buyer can buy from seller through the BP-mechanism.
\item Seller has positive bonds only, buyer has free assets only \\ No trading between them but buyer will act as seller and will sell assets up to optimists, thus generating cash which creates then the same situation as in 2.
\item Seller has positive bonds only, buyer has collateralized assets only \\ This is the final allocation of medianists which hold positive bonds only and optimists which hold collateralized assets only.
\item Seller has free assets only, buyer has cash only \\ Buyer can buy assets from seller against cash.
\item Seller free assets only, buyer has positive bonds only \\ Buyer can by the assets against bonds.
\item Seller has free assets only, buyer has collateralized assets \\ Buyer can buy free assets against bonds. TODO: wirklich?
\item Seller has collateralized assets only, buyer has positive bonds only \\ Buyer can buy assets against bonds.
\item Seller has collateralized assets only, buyer has collateralized assets only \\ Buyer can buy assets against bonds. TODO: wirklich?
\item Seller has collateralized assets, buyer has free assets \\ No trading between them but buyer will act as seller and will sell assets up to optimists against cash or bonds, thus generating cash or positive bonds which is then same as in 9 or 11.
\item Seller: collateralized assets only, buyer has cash only \\ This is the blocking situation as the buyer has no possibility to buy the collateralized assets and cannot get its hands on bonds or assets any more as it is only the seller towards higher optimistic agents which would be the only one who could provide the buyer with those goods.
\end{enumerate}

TODO:
- formally describe the blocking situation
- explain that it is only possible on the asset/bond market
